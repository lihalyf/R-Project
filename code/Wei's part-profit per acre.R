...
for (rows in 1:nrow(valid_land)) {
  if (valid_land[rows, 's8aq3'] == 1) {
    valid_land[rows, 'land_in_acre'] = valid_land[rows, 's8aq3'] * valid_land[rows, 's8aq4']
  }
  if (valid_land[rows, 's8aq3'] == 2) {
    valid_land[rows, 'land_in_acre'] = valid_land[rows, 's8aq3'] * valid_land[rows, 's8aq4'] * 0.00625 #1 square pole = 0.00625 ac 
  }
  if (valid_land[rows, 's8aq3'] == 3) {
    valid_land[rows, 'land_in_acre'] = valid_land[rows, 's8aq3'] * valid_land[rows, 's8aq4'] * 0.00918274 #1 square rope = 0.00918274 ac
  }
}
